...
const ROUTES: Array<{ path: string; label: string; group: string }> = [
  ...
  { path: "/supply",          label: "NM Supply",            group: "Vận hành ngày" },
  { path: "/demand-weekly",   label: "Demand Weekly",        group: "Vận hành ngày" },
  { path: "/drp",             label: "DRP",                  group: "Vận hành ngày" },
  { path: "/allocation",      label: "Allocation / LCNB",    group: "Vận hành ngày" },
  { path: "/orders",          label: "Đơn hàng",             group: "Vận hành ngày" },
  { path: "/transport",       label: "Vận chuyển",           group: "Vận hành ngày" },
  { path: "/sync",            label: "Đồng bộ",              group: "Vận hành ngày" },
  { path: "/supplier-portal", label: "Cổng nhà cung cấp",    group: "Đối tác" },
