---
name: Orders module
description: Orders module — 3 tabs (PO Approval queue · BPO Burn-down · Shipment Tracking) with stage pipeline header and shipment drawer
type: feature
---
...
**Tab 2 — BPO Burn-down**: Per-NM rows with stacked progress bar (Delivered green / In-transit info / Released primary / Remaining gray) + waterfall numbers (BPO total − Delivered = Còn lại). Click row to inline-expand RPO/ASN children table.
